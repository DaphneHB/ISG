...
public class PP extends Thread{
	 ...
	 */
	public Point2D.Float getMapSize () throws InstantiationException, PPException{
		float [] taille;
	 ...
	 * @throws InstantiationException on allocation problem.
	 */
	public Point2D.Float getStartPosition () throws InstantiationException,
			PPException {
		float [] pos;
	 ...
	 */
	public Point2D.Float getSpecialAreasPosition (int z)
