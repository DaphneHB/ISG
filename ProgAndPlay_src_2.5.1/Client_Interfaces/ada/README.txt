This file describes instructions in order to test Ada example.
Linux Users: You have to install "gnat" and "g++" compilers as well as Boost (1.42) and "make" tool in your computer.
...
4) Launch the game
5) Run example: write "example" in your console
...
3) To compile your own program, adapt following command to your own situation:
	gnatmake -I. -L. myProgram.adb -largs -ladaDevice -largs -lpp-client

Note : All functions and constants usable with the game are described in files "./spec/constantlistkp41.ads" and "./spec/pp.ads". Do not hesitate to consult it.